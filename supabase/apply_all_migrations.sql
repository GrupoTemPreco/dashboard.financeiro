...
-- Migration: 20251216150035_rename_tables_to_portuguese.sql
-- Note: Esta migration renomeia tabelas, mas o código ainda usa os nomes originais
-- As queries funcionam porque o Supabase trata nomes de forma case-insensitive

-- Migration: 20260122161232_create_performance_indexes.sql
-- Índices para melhorar performance das queries (incluindo business_unit para filtros por loja/grupo)
...
-- Migration: 20260123000000_add_soft_delete_to_importacoes.sql
